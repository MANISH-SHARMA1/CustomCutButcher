...
function Signup() {
  return (
    <div className="flex flex-col items-center gap-4 py-16 px-4 md:px-8 lg:px-16">
      <p className="font-semibold text-2xl text-center">Sign Up Now</p>
      ...
      <div className="flex flex-col md:flex-row gap-3 items-center">
        ...
        />
        <button className="bg-green-900 text-white py-2 px-4 w-full md:w-auto hover:opacity-95">SUBSCRIBE</button>
      </div>
    </div>
  );
}
