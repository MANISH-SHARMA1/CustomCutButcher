  ...
  return (
    <div className="flex flex-col items-center gap-4 py-16 px-4 md:px-8 lg:px-16">
      ...
      <p className="text-center text-sm max-w-lg">
        For early bird discounts, exclusive offers, product announcements - plus
        a few surprises.
      </p>
      <div className="flex flex-col md:flex-row gap-3 items-center">
        ...
        />
        <button
          style={{ backgroundColor: "#649748" }}
          className="text-white text-sm lg:text-base py-2 px-4 w-full md:w-auto hover:opacity-95"
        >
          SUBSCRIBE
        </button>
      </div>
